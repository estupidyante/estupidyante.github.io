...
(function (window)
{
    TutorialScene.prototype = new Container();
    function TutorialScene()
    {
        var THIS = this;
        THIS.super_initialize = TutorialScene.prototype.initialize; //unique to avoid overiding base class
        ...
        {
            // trace("TutorialScene.initialize..");
        ...
        {
            util.toggleUI(false);
            bg = util.getAssetBitmap("tutorialBg");
            THIS.addChild(bg);
            THIS.showWorlds();
